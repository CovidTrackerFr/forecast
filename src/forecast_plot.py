...
def plot_and_export(df_dlog_all=None, yhat_mean=None, yhat_conf_int_0=None, yhat_conf_int_1=None, yhat_conf_int_2=None, yhat_conf_int_3=None, yhat_conf_int_75_0=None, yhat_conf_int_75_1=None, yhat_conf_int_75_2=None, yhat_conf_int_75_3=None, name_fig="model_output"):
    ...
    fig.add_annotation(
        ...
        xref="paper",
        yref="paper",
        text="Model VARMAX(p=14, q=0). Endog variables: dlog(new_cases), dlog(hosp_admissions), dlog(ICU_adm), dlog(deaths).<br>Exog variables : dlog(booster_cumsum). All variable are smoothed (rolling 7 days mean).<br>Confidence interval 97% and 75%.",
        showarrow=False
    )
    ...
    fig.add_annotation(
        ...
        yref="paper",
        font=dict(size = 15),
        text="Author : @GuillaumeRozier. Based on the work, and with the help of @paldama.",
        showarrow=False   
    )
